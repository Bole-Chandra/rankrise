    ...
    <div className="top-bar" style={{ background: '#015927', padding: '6px 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
      <div className="container">
        <div className="row align-items-center gy-2">
          ...
          <div className="col-6 col-md-7 order-1">
            <div className="top-contact d-flex flex-column flex-md-row justify-content-start align-items-start align-items-md-center gap-1 gap-md-3">
              <a href="tel:9948962952" onClick={() => trackCallClick('9948962952', 'top_bar')} className="d-flex align-items-center text-white text-decoration-none mb-2">
              ...
              <a href="tel:8886945745" onClick={() => trackCallClick('8886945745', 'top_bar')} className="d-flex align-items-center text-white text-decoration-none">
              ...
              {/* Email (Desktop only) */}
              <a href="mailto:info@rankrise.in" className="d-none d-lg-flex align-items-center text-white text-decoration-none">
          ...
          <div className="col-6 col-md-5 order-2">
            <div className="top-buttons d-flex justify-content-end align-items-center gap-2">
